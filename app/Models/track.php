...
/**  Using this php functions   we can analyze an mp3 file and determine if
* it has a constant bitrate or a variable bitrate (CBR vs VBR),
* and determine its length, its bitrate (128 is common) and other data stored in the mp3 frame header.
* For reference http://www.mp3-tech.org/programmer/frame_header.html was used as an mp3 frame spec.
*/
    ...
    {
        $filename = public_path($this->audio);
