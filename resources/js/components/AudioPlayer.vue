			...
			<div class="player-controls">
				...
				<div id="seek">
					...
					<div class="player-time">
						<div class="player-time-current"  >{{ convertTimeSecondsHHMMSS}}</div>
						<div class="player-time-total" >{{convertTimedurationHHMMSS}}</div>
					</div>
				</div>
...
export default {
	...
	computed: {
        ...
        convertTimeSecondsHHMMSS() {
			let hhmmss = new Date(this.currentSeconds * 1000).toISOString().substr(11, 8);

			return hhmmss.indexOf("00:") === 0 ? hhmmss.substr(3) : hhmmss;
		},
         convertTimedurationHHMMSS() {
			let hhmmss = new Date(this.durationSeconds * 1000).toISOString().substr(11, 8);
